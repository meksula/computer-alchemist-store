...
import com.computeralchemist.store.domain.store.components.computerCase.ComputerCase;
import com.computeralchemist.store.domain.store.components.cpu.Cpu;
import com.computeralchemist.store.domain.store.components.disk.Disk;
import com.computeralchemist.store.domain.store.components.gpu.GraphicsCard;
import com.computeralchemist.store.domain.store.components.motherboard.Motherboard;
import com.computeralchemist.store.domain.store.components.ram.Ram;
import com.computeralchemist.store.domain.store.components.supply.PowerSupply;
